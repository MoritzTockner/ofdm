...
# ACDS 20.1 720 win32 2021.12.15.22:07:35
# ----------------------------------------
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/hyper_opt_OFF_pkg.vhd"                         -work work
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_lib_pkg.vhd"                  -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_bit_reverse_addr_control.vhd"        -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_bit_reverse_core.vhd"                -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_bit_reverse_reverse_carry_adder.vhd" -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_adder_fp.vhd"                 -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_addsub.vhd"                   -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_bfi.vhd"                      -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_bfii.vhd"                     -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_bf_control.vhd"               -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_cma.vhd"                      -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_cma_adder_fp.vhd"             -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_cma_bfi_fp.vhd"               -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_cma_fp.vhd"                   -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_core.vhd"                     -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_counter.vhd"                  -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_delay.vhd"                    -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_enable_control.vhd"           -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_stage.vhd"                    -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_stg_out_pipe.vhd"             -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_stg_pipe.vhd"                 -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_top.vhd"                      -work work
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../src/aldec/auk_dspip_r22sdf_twrom.vhd"                    -work work
