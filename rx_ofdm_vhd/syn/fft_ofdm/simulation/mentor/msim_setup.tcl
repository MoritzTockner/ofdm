...
# ----------------------------------------
# If fft_ofdm is one of several IP cores in your
...
# ----------------------------------------
# ACDS 20.1 720 win32 2022.01.11.20:13:03
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/fft_ofdm_fft_ii_0_3n128sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_ofdm_fft_ii_0_1n128cos.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_ofdm_fft_ii_0_1n128sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_ofdm_fft_ii_0_2n128cos.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_ofdm_fft_ii_0_2n128sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_ofdm_fft_ii_0_3n128cos.hex ./
}
...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fft_ofdm_fft_ii_0.sv"                               -work fft_ii_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/fft_ofdm.vhd"                                                                
}
