...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/fft_ofdm_tb/simulation/submodules/auk_dspip_text_pkg.vhd"                    -work fft_ii_0                
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/fft_ofdm_tb/simulation/submodules/auk_dspip_math_pkg.vhd"                    -work fft_ii_0                
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/fft_ofdm_tb/simulation/submodules/auk_dspip_lib_pkg.vhd"                     -work fft_ii_0                
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/fft_ofdm_tb/simulation/submodules/auk_dspip_roundsat.vhd"                    -work fft_ii_0                
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/fft_ofdm_tb/simulation/submodules/auk_dspip_avalon_streaming_sink.vhd"       -work fft_ii_0                
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/fft_ofdm_tb/simulation/submodules/auk_dspip_avalon_streaming_source.vhd"     -work fft_ii_0                
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/fft_ofdm_tb/simulation/submodules/auk_dspip_avalon_streaming_controller.vhd" -work fft_ii_0                
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fft_ofdm_tb/simulation/submodules/fft_ofdm_fft_ii_0.sv"                      -work fft_ii_0                
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/fft_ofdm_tb/simulation/submodules/altera_conduit_bfm_0002_vhdl_pkg.vhd"      -work fft_ofdm_inst_source_bfm
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/fft_ofdm_tb/simulation/submodules/altera_conduit_bfm_0002.vhd"               -work fft_ofdm_inst_source_bfm
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/fft_ofdm_tb/simulation/submodules/altera_conduit_bfm_vhdl_pkg.vhd"           -work fft_ofdm_inst_sink_bfm  
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/fft_ofdm_tb/simulation/submodules/altera_conduit_bfm.vhd"                    -work fft_ofdm_inst_sink_bfm  
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/fft_ofdm_tb/simulation/submodules/altera_avalon_reset_source.vhd"            -work fft_ofdm_inst_rst_bfm   
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/fft_ofdm_tb/simulation/submodules/altera_avalon_clock_source.vhd"            -work fft_ofdm_inst_clk_bfm   
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/fft_ofdm_tb/simulation/submodules/fft_ofdm.vhd"                              -work fft_ofdm_inst           
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/fft_ofdm_tb/simulation/fft_ofdm_tb.vhd"                                                                    
fi
